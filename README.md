# DinoChat ~Powered By Legendesk Pvt. Ltd.


## Description
DinoChat App | A MEAN stack based real time chat application
...
```
    1). Visitor chat with agent.
    2). One to One chat (VtoA).
    3). One to Many chat (AtoV).
